...
object MetricsActor {
  ...
  protected[this] lazy val tweetMeter  = meterFor("net.lockney.tweets.meter")
  protected[this] lazy val emojisSeen  = counterFor("net.lockney.emojisSeen")
  protected[this] lazy val urlsSeen    = counterFor("net.lockney.urlsSeen")
  protected[this] lazy val picsSeen    = counterFor("net.lockney.picsSeen")
